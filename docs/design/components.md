...
- **Mobile:** 760px 以下頂部保留品牌、活動與搜尋；工具選單收納字級、資料管理、使用說明。日期／場館浮在地圖上方，底部「探索／行程」兩入口承載工作內容，篩選位於探索內。
...
- **Map Side Panel:** 桌機條件式覆蓋地圖右側，寬至多 330px、頂與右側 16px、底部 76px；無選取不留空欄。關閉保留選取與 URL，還原觸發焦點。760px 以下使用獨立摘要：回結果／收起、代碼與名稱、最多兩行介紹、加入行程／收藏／查看完整資訊。收起保留選取，完整資訊關閉回到原摘要按鈕。
