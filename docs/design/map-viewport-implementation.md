...
> 歷史範圍註記（2026-09-12）：本文記錄桌機改版當時的設計與驗收。所有「手機保留四頁籤／沿用原規則／原關閉語意」敘述已由 [ADR-0056](../adr/0056-mobile-map-uses-workspace-and-selection-summary.md) 取代；現行手機為探索／行程兩入口、獨立摘要與收合預留矩形 fit，驗收見 [手機方案 B](./mobile-map-panel-plan.md#8-實作與驗收紀錄2026-09-12)。歷史測試數字不作為本次手機驗收。
