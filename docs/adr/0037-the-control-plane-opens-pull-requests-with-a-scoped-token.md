...
- **部分被取代**（2026-09-23 標註）：「不得合併」由 [ADR-0046](./0046-approved-organizer-publications-may-merge-app-owned-pull-requests.md) 取代；路徑限制、不可直接寫既有分支、不可繞過 repository ruleset 與稽核要求仍有效。
