...
- **狀態**：Accepted
- **部分被取代**（2026-09-23 標註）：「結果」中本機 `/editor` 保留為備援一句由 [ADR-0049](./0049-the-local-authoring-backup-is-withdrawn.md) 取代；決策第 5 點的推進方式由 [ADR-0062](./0062-publication-wakes-through-webhooks-and-a-dedicated-cron.md) 改為 webhook 喚醒、獨立 cron 推進。
- **日期**：2026-08-31
