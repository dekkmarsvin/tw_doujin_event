...
- 狀態：已定案（2026-08-19）；Error 1027 的未實測後果敘述已由 [ADR-0031](./0031-quota-exhaustion-is-not-a-release-gate.md) 取代；上傳邊界表的「單檔容量 2 MiB」已由 [ADR-0053](./0053-the-thumbnail-upload-asks-for-the-picture-only.md) 放寬為 5 MiB
