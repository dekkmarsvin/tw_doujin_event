...
| 主辦工作區與發布 | 0035、0037、0038、0046、0047、0050、0057、0058、0059、0062、0066、0068、0069 |
| 地圖貢獻 | 0033 |
| 活動資料與 reference | 0012、0014、0026、0028、0032、0039、0068 |
...
| [0017](./0017-thumbnails-are-self-hosted-with-external-urls-kept.md) | 縮圖由本站代管，外部網址保留為第二條線 | **部分被取代** — Error 1027 的後果敘述由 0031 取代；主機允許清單由 0052 移除；上傳邊界表的單檔容量由 0053 放寬到 5 MiB；Free 額度的成本敘述由 0065 取代。代管為主線的決策不變 |
...
| [0031](./0031-quota-exhaustion-is-not-a-release-gate.md) | 配額耗盡不作發布 gate，Pages Functions 設為 fail-open | **部分被取代** — Free 每日耗盡的問題前提由 0065 取代。不作 gate 與 fail-open 的決策不變 |
