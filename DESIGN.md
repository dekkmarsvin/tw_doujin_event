...
桌機工作區採三欄：左欄切換搜尋／篩選與行程規劃，中欄保留可平移縮放的 SVG 地圖，右欄同時容納攤位詳情與當日行程。寬度低於 1050px 時右欄成為地圖右側浮層；760px 以下隱藏左右欄，改用底部工作面板的「篩選／結果／詳情／行程」四頁籤，地圖持續留在主畫面。規劃資料管理在 760px 以下採貼底模式；地圖 authoring 不屬於公開 Pages 版面。
