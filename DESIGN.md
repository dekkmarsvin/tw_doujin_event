...
- **Editor:** 管理員可拖曳或輸入座標調整一般攤位、柱子與出入口，並新增、命名、分類、縮放或移除企業攤、舞台及其他非一般攤位區。選取企業攤或舞台後，物件四角顯示直接縮放把手；編輯畫布提供 100% 至 400% 檢視縮放、原生捲動、倍率重設與聚焦選取；方向鍵移動 1px，Shift 加方向鍵移動 10px。
