...
桌機工作區採探索／行程共用左欄與 SVG 地圖兩區；詳情選取時覆蓋地圖右側，不占 grid 欄位。>1050px 左欄 296px，761–1050px 為 248px；頁籤與導航切換不改欄寬。詳情寬至多 330px，頂與右側 16px、底部 76px，內容獨立捲動。760px 以下保留底部四頁籤及精簡、半展開約 44vh、完整約 82vh 三段高度。資料管理固定在頂部關於旁；對話框 portal 到文件根層。
