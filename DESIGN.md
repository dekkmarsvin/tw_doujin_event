...
- **Area Switcher:** FF47 是單一展館，固定顯示全館，介面上不出現區域切換控制。
...
- **Full Detail:** 桌機使用左側媒體幻燈片與右側獨立捲動的資訊欄；760px 以下改為媒體在上、資訊在下的單欄順序。切換控制與圖片來源置於影像之外。
...
- **Attribution Badge:** 社團自填內容顯示為「社團自述／尚未驗證」的中性標籤，**不得以版面權重暗示已獲主辦確認**。
