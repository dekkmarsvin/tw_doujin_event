...
export const IDENTITY_TABLES = [
  ...
  table("organizer_venue_spaces", [
    "id TEXT PRIMARY KEY NOT NULL",
    "venue_id TEXT NOT NULL",
    "name TEXT NOT NULL",
    "name_key TEXT NOT NULL",
    "source_url TEXT",
    "default_area_mode TEXT NOT NULL DEFAULT 'imported'",
    "created_by TEXT NOT NULL",
    "created_at INTEGER NOT NULL",
  ]),
  ...
  table("organizer_publication_jobs", [
    ...
    "workflow_retry_attempt INTEGER",
    "production_manifest_sha256 TEXT",
    "failure_code TEXT",
...
export const IDENTITY_COLUMN_MIGRATIONS = [
  ...
  { table: "organizer_publication_jobs", column: "workflow_run_attempt", sql: "ALTER TABLE organizer_publication_jobs ADD COLUMN workflow_run_attempt INTEGER" },
  { table: "organizer_publication_jobs", column: "workflow_retry_attempt", sql: "ALTER TABLE organizer_publication_jobs ADD COLUMN workflow_retry_attempt INTEGER" },
  { table: "organizer_publication_jobs", column: "production_manifest_sha256", sql: "ALTER TABLE organizer_publication_jobs ADD COLUMN production_manifest_sha256 TEXT" },
