...
export default function EventMapApp() {
  ...
  const mapRecords = useMemo(() => navigationMode
    ...
    : filtered,
  [day, dayPlan, filtered, navigationMode]);
